...
PICS = (environ.get('PICS', 'https://postimg.cc/NKDytw7P')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://postimg.cc/NKDytw7P")
MELCOW_VID = environ.get("MELCOW_VID", "https://t.me/c/2040575112/2768")
SPELL_IMG = environ.get("SPELL_IMG", "https://postimg.cc/NKDytw7P")

# Admins, Channels & Users
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002374955566'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7348205141 7336971189 1249672673').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002493086447').split()]
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Prime_Movie_Request_bot')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+eEMdl7-M_5RmMWNl')
